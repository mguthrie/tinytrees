                ...
                <div className="container">
                    ...
                    <div className="grid md:grid-cols-3 grid-cols-1 mt-8 gap-[30px] items-center">
                        <div className="shadow rounded-md p-6 bg-gradient-to-t bg-violet-600">
                            <div className="pb-8">
                                <h3 className="mb-6 text-xl font-medium text-white font-lexend">Business</h3>
                        ...
                        <div className="p-6">
                            <div className="pb-8">
                                <h3 className="mb-6 text-xl font-medium dark:text-white font-lexend">Free</h3>
                        ...
                        <div className="p-6">
                            <div className="pb-8">
                                <h3 className="mb-6 text-xl font-medium dark:text-white font-lexend">Corporate</h3>
                                <div className="mb-6 dark:text-white/50 font-lexend">
                                    <span className="relative h6 -top-5 text-xl">$</span>
